import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,r as n}from"./iframe-CX_IkDeK.js";var r,i,a,o,s,c,l,u,d;function f(){return(f=e((()=>{t(),{within:r,userEvent:i}=__STORYBOOK_MODULE_TEST__,{expect:a}=__STORYBOOK_MODULE_TEST__,o={title:`Role/role="marquee"`},s=()=>n(`
        <div role="marquee">
        </div>
        `,`
        <div role="marquee">
        ...
        `),u.storyName=`Sibling is visible ⚠️`,u.play=async({canvasElement:e})=>{let t=r(e).getByRole(`button`);a(`Hello world`).not.toBeAnnounced(),await i.click(t),a(`world`).toBeAnnounced(`polite`),a(`Hello world`).not.toBeAnnounced(),a(`world`).not.toBeAnnounced()},d=[`WithTextContent`,`WrapsLiveRegion`,`WrappedInLiveRegion`,`SiblingIsVisible`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
