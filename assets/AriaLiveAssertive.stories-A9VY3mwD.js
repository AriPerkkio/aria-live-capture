import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,r as n}from"./iframe-CX_IkDeK.js";var r,i,a,o,s,c,l,u,d,f,p,m;function h(){return(h=e((()=>{t(),{within:r,userEvent:i}=__STORYBOOK_MODULE_TEST__,{expect:a}=__STORYBOOK_MODULE_TEST__,o={title:`Aria-live/aria-live="assertive"`},s=()=>n(`
        ...
        `),p.storyName=`Part of content changes ✅`,p.play=async({canvasElement:e})=>{let t=r(e).getByRole(`button`);a(`Hello world`).not.toBeAnnounced(),await i.click(t),a(`Hello world`).toBeAnnounced(`assertive`)},m=[`LiveRegionAvailableBeforeContent`,`LiveRegionUnavailableBeforeContent`,`AnchestorIsHidden`,`LiveRegionIsHidden`,`ContentIsHidden`,`ContentIsPartiallyHidden`,`PartOfContentChanges`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  ...
  return createMountToggle(\`
        ...
        \`);
}`,...p.parameters?.docs?.source}}}})))()}h();export{l as AnchestorIsHidden,d as ContentIsHidden,f as ContentIsPartiallyHidden,s as LiveRegionAvailableBeforeContent,u as LiveRegionIsHidden,c as LiveRegionUnavailableBeforeContent,p as PartOfContentChanges,m as __namedExportsOrder,o as default};